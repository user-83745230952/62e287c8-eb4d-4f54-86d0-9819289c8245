...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 38862848;
...
var ASM_CONSTS = {
 ...
 1343346: () => Module["SDL3"].audioContext.sampleRate,
 1343397: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 1348951: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 1349010: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 1360705: () => window.innerWidth,
 1360735: () => window.innerHeight,
 1360766: $0 => {
